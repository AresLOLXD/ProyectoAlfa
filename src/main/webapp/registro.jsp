                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5 ">
                                ...
                                <form class="row" action="">
                                    ...
                                    <div>
                                        <i class="fas fa-user-plus fa-4x p-2 m-2"></i>
                                    </div>
                                    <h2 class="fw-bold mb-2 text-uppercase">Registrarse </h2>
                                    <p class="text-white-50 mb-5">¡Ingrese todos los datos para resgistrarse!</p>
                            ...
                            <div>
                                <p class="mb-0">Ya tienes una cuenta? <a href="/login.html" class="text-white-50 fw-bold">Inicia Sesión!!!</a></p>
                            </div>
